...
from backend.bot.handlers import start, schedule, homework, settings as bot_settings, admin, group, facts, economy, birthdays, polls, now, natbirzha, custom_schedule
