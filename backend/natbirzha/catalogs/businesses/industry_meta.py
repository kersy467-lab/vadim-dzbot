...
INDUSTRIES = {
    ...
    "construction": {"name": "Строительство", "icon": "🏗️", "target_share": 0.08, "difficulty": 3, "summary": "Стройматериалы и мощность для корпоративных проектов."},
    ...
    "logistics": {"name": "Логистика", "icon": "🚚", "target_share": 0.07, "difficulty": 3, "summary": "Перевозки, терминалы, склады и транспортная мощность."},
}
