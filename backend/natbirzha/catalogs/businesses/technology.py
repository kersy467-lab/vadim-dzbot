...
TECHNOLOGY_BUSINESSES = {
    spec["id"]: spec for spec in [
        _t("electronics_workshop", "Электронная мастерская", "🔌", 1, 12_000, 1,
           {"copper": 10, "silver_ore": 0.1, "plastics": 4, "energy": 6}, {"components": 18},
        ...
        _t("electrical_factory", "Завод электротехники", "⚡", 2, 30_000, 5,
           {"copper": 14, "aluminum": 0.25, "components": 6, "energy": 8}, {"electrical_equipment": 14, "machinery": 4},
        ...
        _t("battery_system_factory", "Завод аккумуляторных систем", "🔋", 7, 900_000, 29,
           {"lithium_pure": 6, "cobalt_raw": 2, "electrolyte": 4, "electronics": 3, "energy": 20}, {"batteries": 8},
        ...
        _t("microelectronics_complex", "Микроэлектронный комплекс", "💾", 8, 1_800_000, 36,
           {"rare_earths": 2, "gold_ore": 1, "diamonds": 0.5, "industrial_gases": 4, "ultrapure_water": 12, "energy": 34}, {"electronics": 10},
