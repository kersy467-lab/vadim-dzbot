...
def resource_business_rates(
    ...
    *,
    ...
    New career businesses deliberately grow output faster than inputs. This is
    the core efficiency progression: a level-50 automated mine is larger but
    also more efficient per unit of product than its level-1 predecessor.
    """
    stage = max(1, int(business.stage))
