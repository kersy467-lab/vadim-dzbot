...
(function () {
  ...
  async function openOnlineRoom(roomId, gameType) {
    ...
    if (target === "ege_stress_duel" || target === "ege_vocabulary_duel") {
      ...
      return window.EGE_DUEL?.open?.(roomId, target);
    }
  ...
  window.GAMES = Object.assign(window.GAMES || {}, {
    ...
    // Checkers Methods
    startBotCheckersGame: (c) => window.GAMES_CHECKERS?.startBotGame(c), startLocalCheckersGame: () => window.GAMES_CHECKERS?.startLocalGame(),
    toggleCheckersAutoRotate: () => window.GAMES_CHECKERS?.toggleAutoRotate(), flipCheckersBoardManual: () => window.GAMES_CHECKERS?.flipBoardManual(),
    openCheckersOnlineRoom: (c) => window.GAMES_CHECKERS?.openOnlineRoom(c), inviteCheckersClassmate: (id, n) => window.GAMES_CHECKERS?.inviteClassmate(id, n),
    checkersSquareClick: (sq) => window.GAMES_CHECKERS?.squareClick(sq), resignCheckersGame: () => window.GAMES_CHECKERS?.resignGame(),
    requestCheckersRematch: () => window.GAMES_CHECKERS?.requestRematch(), cancelCheckersGame: () => window.GAMES_CHECKERS?.cancelCheckersGame(),
