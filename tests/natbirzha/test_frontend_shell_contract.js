...
assert(natHtml.includes('app.js?v=20260925_deals_v9') || natHtml.includes('app.js?v=20260925_deals_v8') || natHtml.includes('app.js?v=20260925_deals_v7') || natHtml.includes('app.js?v=20260925_supply_deals'), 'Natbirzha entrypoint must refresh its cached code after a release');
