...
assert(natHtml.includes('app.js?v=20260925_supply_deals') || natHtml.includes('app.js?v=20260925_multisab_v4'), 'Natbirzha entrypoint must refresh its cached code after a release');
